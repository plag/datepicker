...
import { subDays, startOfMonth, format, addDays } from 'date-fns';
...
const PRESETS = [
  ...
  {
    value: {
      [Range.FROM]: format(subDays(addDays(TODAY, 1), 7), FORMAT),
      [Range.TO]: format(TODAY, FORMAT),
    },
    label: 'Last 7 days',
  },
  {
    value: {
      [Range.FROM]: format(subDays(addDays(TODAY, 1), 30), FORMAT),
      [Range.TO]: format(TODAY, FORMAT),
    },
    label: 'Last 30 days',
  },

...
class DateTimeDays extends Component<DateTimeDaysProps> {
          ...
          <tr>
            {
              !this.props.disableWeekDays && makeWeekArray(startOfWeek(periodStartDate, { weekStartsOn: 1 })).map(day => {
                return (<th className="date-time__week-day" key={ format(day, 'dd') }>{ format(day, 'E') }</th>);
              })
            }
          </tr>
        </thead>
                  ...
                  ? <td
                    ...
                    className={
                      classnames('date-time__day', {
                        ...
                        'date-time__day--is-focused': this.props.focusedDay ? isSameDay(day, this.props.focusedDay) : false,
                      })
                    }
  ...
  private isFirstDateInRange = (date: Date): boolean => {
  ...
  private isLastDateInRange = (date: Date): boolean => {
  ...
  private handleCellClick = (e): void => {
